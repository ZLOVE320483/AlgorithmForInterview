...
class Solution {
    public int maxConsecutiveAnswers(String answerKey, int k) {
        return Math.max(maxConsecutiveAnswersHelper(answerKey, k, 'T'),
                maxConsecutiveAnswersHelper(answerKey, k, 'F'));
    }

    private int maxConsecutiveAnswersHelper(String answerKey, int k, char ch) {
